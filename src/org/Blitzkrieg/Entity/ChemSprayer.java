...
public class ChemSprayer extends Tower{
	...
	public void init(GameContainer gc, StateBasedGame game, int mouseX, int mouseY)
		...
		image = new Image("res/images/entities/ChemSprayer/ChemSprayerImage.png");
		spray = new Animation(new SpriteSheet("res/images/entities/ChemSprayer/ChemSprayer.png", 24, 24), 300);
